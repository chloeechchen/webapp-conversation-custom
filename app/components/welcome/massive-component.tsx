...
export const AppInfoComp: FC<{ siteInfo: AppInfo }> = ({ siteInfo }) => {
  ...
  return (
    <div>
      <div className='flex items-center py-2 text-xl font-medium text-gray-700 rounded-md'>👏 {t('app.common.welcome')} {siteInfo.name}</div>
...
export const ChatBtn: FC<{ onClick: () => void; className?: string, btnStyle: IButtonStyleProps }> = ({
  className,
  onClick,
  btnStyle
}) => {
